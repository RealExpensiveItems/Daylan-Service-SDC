...
const generateScaleData = (num) => {
  ...
  // var obj = JSON.stringify(fakeData).slice(1, JSON.stringify(fakeData).length-1)

  // return JSON.stringify(fakeData).slice(1, JSON.stringify(fakeData).length-1);
